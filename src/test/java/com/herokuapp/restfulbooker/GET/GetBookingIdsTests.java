...
public class GetBookingIdsTests extends BaseTest {
    ...
    public void getBookingIdsWithoutFilterTest() {
        ...
        Response myresponse = createBooking();
...
//  Assert.assertFalse(bookingIds.isEmpty(), "List of bookingIds is empty, but it shouldn't be like that.");
    ...
    //QUERY PARAMETER _> filtering parameter
    @Test
    public void getBookingIdsWithFilterTest() {
        ...
        spec.queryParam("firstname", "Baturay");

        //Get Response with Booking ids
        Response myresponse = RestAssured.given(spec).get("/booking");
        //Response myresponse = RestAssured.given(spec).get("/booking?firstname=Baturay");
        myresponse.print(); //this will print the response body.
